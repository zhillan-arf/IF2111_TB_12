...
void MesinWaktu (State *state, player *P, int JumPetak, TabPeta peta, TabTP arrtp, int val, int idx_choice, int idx_player);
// Skill ke-2
...
void BalingBalingJambu (State *state, player *P, int JumPetak, TabPeta peta, TabTP arrtp, int val, int idx_choice, int idx_player);
// Skill ke-3
